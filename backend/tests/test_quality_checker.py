...
class TestCalculateTicketQuality:
    ...
    def test_poor_quality_ticket_missing_resolution(self):
        ...
        ticket = {"ticket_id": "SNOW003", "description": "Very short", "resolution": ""}
    ...
    def test_poor_quality_ticket_missing_both(self):
        ...
        ticket = {"ticket_id": "SNOW004", "description": "", "resolution": ""}
    ...
    def test_ticket_with_no_fields(self):
        ...
        ticket = {"ticket_id": "SNOW005", "type": "related_change"}
    ...
    def test_ticket_with_whitespace_only(self):
        ...
        ticket = {"ticket_id": "SNOW006", "description": "   ", "resolution": "   "}
...
class TestCalculateTicketsQuality:
    ...
    def test_mixed_quality_tickets(self):
        ...
        tickets = [
            ...
            {"ticket_id": "SNOW003", "description": "", "resolution": ""},
        ]
    ...
    def test_all_poor_quality_tickets(self):
        ...
        tickets = [
            {"ticket_id": "SNOW001", "description": "", "resolution": ""},
            {"ticket_id": "SNOW002", "description": "Short", "resolution": "Fix"},
        ]
