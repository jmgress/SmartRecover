...
class LLMManager:
    ...
    def _create_openai_llm(self, llm_config: LLMConfig) -> ChatOpenAI:
        ...
        logger.info(
            f"Creating OpenAI LLM - model: {openai_config.model}, temperature: {openai_config.temperature}"
        )
    ...
    def _create_gemini_llm(self, llm_config: LLMConfig) -> ChatGoogleGenerativeAI:
        ...
        logger.info(
            f"Creating Gemini LLM - model: {gemini_config.model}, temperature: {gemini_config.temperature}"
        )
    ...
    def _create_ollama_llm(self, llm_config: LLMConfig) -> ChatOllama:
        ...
        logger.info(
            f"Creating Ollama LLM - model: {ollama_config.model}, base_url: {ollama_config.base_url}, temperature: {ollama_config.temperature}"
        )
