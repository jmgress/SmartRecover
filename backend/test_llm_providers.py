...
def test_provider(provider_name: str):
    ...
    try:
        ...
        try:
            ...
            print(
                "⚠️  LLM invocation failed (this is expected without valid API keys/running server):"
            )
        ...
        print(
            f"✅ OrchestratorAgent created successfully with {type(orchestrator.llm).__name__}"
        )
