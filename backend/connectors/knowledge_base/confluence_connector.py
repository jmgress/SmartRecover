...
class ConfluenceConnector(KnowledgeBaseConnectorBase):
    ...
    async def search(
        ...
        logger.warning("Confluence API integration not yet implemented - returning empty results")
        return []
    ...
    async def get_document(self, doc_id: str) -> Dict[str, Any]:
        ...
        logger.warning(f"Confluence API integration not yet implemented - document {doc_id} not found")
        return None
